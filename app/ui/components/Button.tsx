...
const ButtonRoot = forwardRef<HTMLButtonElement, ButtonRootProps>(function ButtonRoot(
  ...
  return (
    <button
      className={cn(
        "group/3b777358 flex h-8 cursor-pointer items-center justify-center gap-2 rounded-md border-none bg-slate-950 px-3 text-left hover:bg-slate-900 active:bg-slate-950 disabled:cursor-default disabled:bg-neutral-200 hover:disabled:cursor-default hover:disabled:bg-neutral-200 active:disabled:cursor-default active:disabled:bg-neutral-200",
        {
    ...
    >
      {icon ? (
        <SubframeCore.IconWrapper
          className={cn("text-body font-body text-white group-disabled/3b777358:text-neutral-400", {
            hidden: loading,
