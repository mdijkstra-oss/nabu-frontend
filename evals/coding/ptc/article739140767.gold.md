...
```json-attributes
{
	...
	"subject": "MS-503 Gang Member Apprehended by Border Patrol Agents In Arizona"
}
```
...
```json-annotations
{
	"annotations": [
		{
			"text": "Rodriguez-Lopez claimed to have previously been a member of, MS-503, a branch of MS-13, a gang that originated in El Salvador and is notorious for extreme violence and bloodshed.",
			"reason": "Gold (Loaded_Language) — span: \"notorious for extreme violence and bloodshed\"",
